...
lazy val root = (project in file("."))
	.settings(
		name := "healthcare-claims-ml-demo",
		...
		// confluent
		libraryDependencies += "io.confluent.ksql" % "ksql-udf" % "5.3.1",

		// scala
		libraryDependencies += "org.apache.kafka" % "kafka-streams-scala_2.12" % "5.3.1-ccs",

		// https://mvnrepository.com/artifact/org.apache.kafka/kafka-clients
		libraryDependencies += "org.apache.kafka" % "kafka-clients" % "5.3.1-ccs",
		...
		libraryDependencies += "org.apache.kafka" % "connect-api" % "5.3.1-ccs",
